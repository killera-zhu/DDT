...
from ts_benchmark.baselines.ddt.utils.tools import EarlyStopping, adjust_learning_rate
...
from ts_benchmark.baselines.ddt.models.ddt_model import DDTModel
...
class DDT(ModelBase):
    ...
    def forecast_fit(self, train_valid_data: pd.DataFrame, train_ratio_in_tv: float) -> "ModelBase":
        ...
        self.model = DDTModel(self.config)
